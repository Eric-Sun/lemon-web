                ...
                <div class="hero">
                    <div id="teaser">
                        <div class="teaser ui-tabs-panel " id="teaser1">
                            <p><img alt="" class="alignleft size-full wp-image-1685" height="294"
                                    src="/upload/<c:out value="${tdto.link1}"/>" width="636"/></p>
                        </div>
                        <div class="teaser ui-tabs-panel ui-tabs-hide" id="teaser2">
                            <p><img alt="" class="alignleft size-full wp-image-1686" height="294"
                                    src="/upload/<c:out value="${tdto.link2 }"/>" width="636"/></p>
                        </div>
                        <div class="teaser ui-tabs-panel ui-tabs-hide" id="teaser3">
                            <p><img alt="" class="alignleft size-full wp-image-1687" height="294"
                                    src="/upload/<c:out value="${tdto.link3 }"/>" width="636"/></p>
                        </div>
                        <div class="teaser ui-tabs-panel ui-tabs-hide" id="teaser4">
                            <p><img alt="" class="alignleft size-full wp-image-938" height="294"
                                    src="/upload/<c:out value="${tdto.link4 }"/>" width="636"/></p>
                        </div>
        ...
        <div class="con01" style="height:305px;">
            ...
            <c:forEach var="p" items="${pdto }" varStatus="status">
                ...
                <c:if test='${status.count%2==0 }'>
                    ...
                    <a href="/p1.jsp"><img width="146" height="135" src="<c:out value='${p.thumbnail}'/>" alt="<c:out value="${p.name}"/>"/></a>
        ...
        <div class="con01">
            <ul>
                <c:forEach var="news" items="${ndto}" varStatus="status">
                    ...
                    <li><a href="/news?id=<c:out value="${news.id }"/>"
            ...
            <div class="con01">
                <ul>
                    <c:forEach items="${hangye}" var="news">
                        <li><a href="/news?id=<c:out value="${news.id}"/>" target="_blank"><c:out
